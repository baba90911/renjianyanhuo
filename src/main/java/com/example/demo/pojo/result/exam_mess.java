...
public class exam_mess {
    ...
    public List<String> getExamRule() {
        return examRule;
    }

    public void setExamRule(List<String> examRule) {
    ...
    public void setExamClassroom2(String examClassroom2) {
        this.examClassroom2 = examClassroom2;
    }
